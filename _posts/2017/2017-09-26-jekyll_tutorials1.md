...
　我这里讲的是部署到 Github Page 创建一个 github 账号，然后创建一个跟你账户名一样的仓库，如你的账户名叫 [testusername]，你的 github 仓库名就叫 [testusername.github.io]，创建好了之后，把刚才建立的 myBlog 项目 push 到 username.github.io仓库里去（username指的是你的github用户名），检查你远端仓库已经跟你本地 myBlog 同步了，然后你在浏览器里输入 username.github.io ，就可以访问你的博客了。
...
虽然博客部署完成了，你会发现博客太简单不是你想要的，你可以使用网上的模板。

首先你要获取jeklly博客模板，将模板clone到你的username.github.io仓下，然后使用命令部署本地服务 
...
```
Configuration file: /Users/tendcloud-Caroline/Desktop/testusername.github.io/_config.yml
...
```
Configuration file: /Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/testusername.github.io-github/_config.yml
            Source: /Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/testusername.github.io-github
       Destination: /Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/testusername.github.io-github/_site
 Incremental build: disabled. Enable with --incremental
      Generating... 
                    done in 0.901 seconds.
 Auto-regeneration: enabled for '/Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/testusername.github.io-github'
Configuration file: /Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/testusername.github.io-github/_config.yml
...
使用了 Jekyll 你会发现如果你想使用多台电脑发博客都很方便，只要把远端 github 仓库里的博客 clone 下来，写文章后再提交就可以了，Hexo 由于远端提交的是静态网页，所有无法直接写 Markdown 的文章。如果你想看 Hexo 搭建博客，可以看看我的另一篇[HEXO搭建个人博客](http://tiger99111.github.io/2015/08/HEXO%E6%90%AD%E5%BB%BA%E4%B8%AA%E4%BA%BA%E5%8D%9A%E5%AE%A2/)的教程。
...
本文转自:http://baixin.io/2016/10/jekyll_tutorials1/
